...
#> [1,]  0.385676  0.681623 0.877884  0.95 12 16  1 16 0.750000 0.062500 0.745532
#> [2,] -0.311899 -0.077955 0.160079  0.95 19 29 22 30 0.655172 0.733333 0.655284
#> [3,] -0.018618  0.091688 0.186718  0.95  5 56  0 29 0.089286 0.000000 0.091688
#>         p2mle
#> [1,] 0.063909
#> [2,] 0.733240
#> [3,] 0.000000
...
#> $estimates
#>          lower       est    upper level x1 n1 x2 n2    p1hat    p2hat    p1mle
#> [1,]  0.374978  0.687500 0.862899  0.95 12 16  1 16 0.750000 0.062500 0.750000
#> [2,] -0.308594 -0.078161 0.158172  0.95 19 29 22 30 0.655172 0.733333 0.655172
#> [3,] -0.032597  0.089286 0.193331  0.95  5 56  0 29 0.089286 0.000000 0.089286
#>         p2mle
#> [1,] 0.062500
#> [2,] 0.733333
#> [3,] 0.000000
...
#> [1,] 0.726449 16.05357   Inf  0.95  5 56  0 29 0.089286     0 0.086496 0.005388
#> 
#> $pval
#>         chisq pval2sided theta0 scorenull pval_left pval_right
...
#> $estimates
#>         lower est upper level x1 n1 x2 n2    p1hat p2hat p1mle p2mle
#> [1,] 0.674037 Inf   Inf  0.95  5 56  0 29 0.089286     0   NaN     0
#> 
#> $pval
#>         chisq pval2sided theta0 scorenull pval_left pval_right
...
#> [1,] 0.033963 0.091716 0.185853  0.95  5 56 0.089286 0.091716
#> [2,] 0.000000 0.005682 0.091707  0.95  0 29 0.000000 0.005682
#> 
#> $pval
#>         chisq   pval2sided theta0 scorenull    pval_left pval_right
...
#> $estimates
#>         lower      est   upper level x1 n1    p1hat    p1mle
#> [1,] 0.038742 0.089286 0.19256  0.95  5 56 0.089286 0.089286
#> [2,] 0.000000 0.000000 0.11697  0.95  0 29 0.000000 0.000000
#> 
#> $pval
#>         chisq   pval2sided theta0 scorenull    pval_left pval_right
#> [1,] 37.78571 7.895787e-10    0.5 -6.147009 3.947893e-10          1
...
#> $estimates
#>         lower      est    upper level x1 n1    p1hat    p1mle
#> [1,] 0.033146 0.092262 0.197110  0.95  5 56 0.089286 0.092262
#> [2,] 0.000000 0.005747 0.097056  0.95  0 29 0.000000 0.005747
#> 
#> $pval
#>         chisq   pval2sided theta0 scorenull    pval_left pval_right
...
#> [1,] 0.245523 0.308755 0.37033  0.95 0.716852 0.407993 0.714365 0.40561
#> 
#> $pval
#>         chisq  pval2sided theta0 scorenull pval_left pval_right
