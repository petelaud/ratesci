...
Similar patterns of coverage are seen for the corresponding methods for a Poisson rate [@laud2017]. (Analysis for Poisson rates is obtained using `distrib = "poi"`, with the input `n` representing the exposure time.)
