...
#' For OR, intervals are produced based on transforming the SCASp interval for
#' the single proportion.
#' Includes options for continuity adjustment, where the magnitude of
...
#'   bias correction in the score denominator. (Under evaluation, manuscript
#'   under review.)
