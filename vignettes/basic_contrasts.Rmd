...
The plots below illustrate the one-sided and two-sided interval coverage probabilities[^1] (i.e. 1 minus the actual probability that the confidence interval contains the true value of $\theta$) achieved by SCAS compared to some other popular methods[^2] with $(n_1, n_2) = (45, 15)$, using moving average smoothing:
