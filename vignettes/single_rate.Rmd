...
```{r}
data(crash)
strat_p <- scoreci(x1 = event.control[-17], n1 = n.control[-17], contrast = "p", stratified = TRUE)
strat_p$estimates
```
...
```{r}
strat_p_rand <- scoreci(x1 = event.control[-17], n1 = n.control[-17], contrast = "p", stratified = TRUE, random = TRUE)
