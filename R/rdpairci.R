...
rdpairci <- function(x,
  ...
  methodnames <- c(
    "SCAS", "SCASu", "AS(N-1)", "AS(Tango)", "MOVER-W", "MOVER-NW", "MOVER-NJ",
  ...
  outarr <- array(
    c(ci_scas, ci_scasu, ci_asbc, ci_tango, ci_moverw, ci_movernw, ci_movernj, ci_wald, ci_agrmin, ci_bp),
