...
To demonstrate equivalence (i.e. no difference in either direction), you would conduct two one-sided tests, e.g. with $\theta_0 = -0.1$ and $\theta_0 = +0.1$. If conducted using a 2.5% significance level, the tests would be significant if the corresponding 95% confidence interval falls entirely within $(-0.1, 0.1)$.
